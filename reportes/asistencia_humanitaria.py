...
@asistencia_humanitaria_bp.route("/api/public/asistencia_humanitaria_json", methods=["GET"])
def asistencia_humanitaria_json():
    ...
    try:
        ...
        sql = "SELECT * FROM dmeva.`3. RED-M Asistencia Humanitaria 2025+` LIMIT %s OFFSET %s"
